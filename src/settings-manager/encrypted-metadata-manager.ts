  ...
  constructor({
    ...
    if (encryptionKey) {
      ...
      if (process.env.NODE_ENV === "production") {
        ...
        throw new Error(
          "Encryption key for the EncryptedMetadataManager has not been set. Setting it for the production environments is necessary. You can find more in the documentation: https://docs.holipoly.io/docs/3.x/developer/extending/apps/developing-apps/app-sdk/settings-manager"
        );
      }
      console.warn(
