...
export const ProtectedHandlerErrorCodeMap: Record<HolipolyProtectedHandlerError, number> = {
  OTHER: 500,
...
/**
 * Wraps provided function, to ensure incoming request comes from Holipoly Dashboard.
