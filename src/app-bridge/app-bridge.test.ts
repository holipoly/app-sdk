...
const domain = "holipoly.domain.host";
const validJwtToken =
...
describe("AppBridge", () => {
  ...
  it("Saves holipolyVersion field if provided in the Handshake event", () => {
    expect(appBridge.getState().holipolyVersion).toBeUndefined();
    ...
    expect(appBridge.getState().token).toEqual(validJwtToken);
    expect(appBridge.getState().holipolyVersion).toEqual("3.15.0");
