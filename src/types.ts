 ...
 * Reference https://docs.holipoly.io/docs/3.x/api-reference/enums/permission-enum
 */
...
/**
 * @see https://docs.holipoly.io/docs/3.x/api-reference/webhooks/enums/webhook-event-type-async-enum
 */
export type AsyncWebhookEventType =
  ...
  | "THUMBNAIL_CREATED";
/**
 * @see https://github.com/holipoly/holipoly/blob/main/holipoly/graphql/schema.graphql#L1995
 *
 */
...
export interface AppManifest {
  /** ID of the application used internally by Holipoly */
  id: string;
  version: string;
  ...
  /** Address to the app configuration page, which is rendered in the dashboard
    @deprecated in Holipoly 3.5, use appUrl instead
  */
  configurationUrl?: string;
  /** Endpoint used during process of app installation

    @see [Installing an app](https://docs.holipoly.io/docs/3.x/developer/extending/apps/installing-apps#installing-an-app) 
  */
  tokenTargetUrl: string;
  /** Short description of privacy policy displayed in the dashboard

    @deprecated in Holipoly 3.5, use dataPrivacyUrl instead
  */
  dataPrivacy?: string;
  ...
  supportUrl?: string;
  /** List of extensions that will be mounted in Holipoly's dashboard

  @see For details, please see the [extension section](https://docs.holipoly.io/docs/3.x/developer/extending/apps/extending-dashboard-with-apps#key-concepts)
  */
  extensions?: AppExtension[];
  /** List of webhooks that will be set.
  
  @see For details, please look at [asynchronous webhooks](https://docs.holipoly.io/docs/3.x/developer/extending/apps/asynchronous-webhooks),
  [synchronous-webhooks](https://docs.holipoly.io/docs/3.x/developer/extending/apps/synchronous-webhooks/key-concepts)
  and [webhooks' subscription](https://docs.holipoly.io/docs/3.x/developer/extending/apps/subscription-webhook-payloads)

  Be aware that subscription queries are required in manifest sections
  */
  webhooks?: WebhookManifest[];
  /**
   * Allows app installation for specific Holipoly versions, using semver.
   * https://github.com/npm/node-semver#versions
   *
   * If not set, Holipoly will allow installation for every version
   *
   * In Holipoly versions lower than 3.13, this field will be ignored
   *
   * Examples:
   ...
   */
  requiredHolipolyVersion?: string;
  /**
   ...
   *
   * Available from Holipoly 3.15. In previous versions will be ignored
   */
  brand?: {
    /**
    ...
    logo: {
      /**
       * URL with the public image. File will be copied to Holipoly database during installation
       *
